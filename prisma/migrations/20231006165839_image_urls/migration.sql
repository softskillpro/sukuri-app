...
-- AlterTable
CREATE SEQUENCE subscription_priority_seq;
ALTER TABLE "Subscription" ALTER COLUMN "priority" SET DEFAULT nextval('subscription_priority_seq');
ALTER SEQUENCE subscription_priority_seq OWNED BY "Subscription"."priority";
